...
def main():
    ...
    blob_service_client = BlobServiceClient(account_url=f"https://functionstacc.blob.core.windows.net", credential=KEY)
    ...
    for blob in blob_list:
        ...
        print(f'what is the type {type(file_content)}')
